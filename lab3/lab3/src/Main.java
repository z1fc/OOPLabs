public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Виведення продуктів з заданим найменуванням
        System.out.println("\nПродукти з найменуванням \"Молоко\":");
        printProductsByName("Молоко");

        // Виведення продуктів з ціною, що не перевищує задану
        System.out.println("\nПродукти з ціною, що не перевищує 20 грн.:");
        printProductsByPrice(20.0); // Зміна на 20.0, бо тепер це Double

        // Виведення продуктів, термін зберігання яких більше заданого
        System.out.println("\nПродукти, термін зберігання яких більше 30 днів:");
        printProductsByShelfLife(30); // Зміна на 30, бо тепер це Integer
    }
    ...
    private static void printProductsByPrice(double maxPrice) {
        for (Product product : products) {
    ...
    private static void printProductsByShelfLife(int minShelfLife) {
        for (Product product : products) {
